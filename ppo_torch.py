...
class PPOMemory:
    ...
    # The network made to approximate the policy


class ActorNetwork(nn.Module):

    # takes the actions the model can choose form 'soft max output options'
    # the input dimensions i.e. the observation dims
    # the learning rate
    # The dims you want your fully connected layers to be
    # The directory you wish to save your model weights to
    def __init__(self, n_actions, input_dims, alpha, fc1_dims=256, fc2_dims=256, chkpt_dir='tmp/ppo'):
        super(ActorNetwork, self).__init__()

        self.checkpoint_file = os.path.join(chkpt_dir, 'actor_torch_ppo')

        # Literally just a basic model with the n_actions as output
        # It looks like torch makes the dimensions look very easy to understand
    ...
    # Do a forward pass
    # With your state as input
    # Categorical basically takes the distribution outputs
    # and encodes them to categories as a potentially more efficicent
    # version of one hot encoding with masking
    ...
    # Creates the gradient of the value function


# which outputs your the estimated value given a state
class CriticNetwork(nn.Module):
    ...
    # The object that uses the Actor and Critic nets
